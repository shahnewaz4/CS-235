...
void Textbook::display(){
  ...
  std::string review = "It has";
	...
	std::cout << getTitle() << " is written by " << getAuthor() << " for " << getGradeLevel() << " students. Subject: " << getSubject() << ". " << review << " review questions. Page Count: " << getPageCount() << ". " << digital << " available digitally.\n";
}
